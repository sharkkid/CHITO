...
public class PlayBookPojo {
    ...
    public static class ScenesBean {
         ...
         * triggers : {"webviewClick":{"id":"go-next","actions":{"gotoScene":{"sceneId":3}}}}
         */
        ...
        public void setTriggers(TriggersBean triggers) {
        ...
        public static class TriggersBean {
            /**
             * webviewClick : {"id":"go-next","actions":{"gotoScene":{"sceneId":3}}}
             */

            private WebviewClickBean webviewClick;

            public WebviewClickBean getWebviewClick() {
                return webviewClick;
            }

            public void setWebviewClick(WebviewClickBean webviewClick) {
                this.webviewClick = webviewClick;
            }

            public static class WebviewClickBean {
                /**
                 * id : go-next
                 * actions : {"gotoScene":{"sceneId":3}}
                 */
                ...
                public static class ActionsBean {
                    ...
                    private GotoSceneBean gotoScene;

                    public GotoSceneBean getGotoScene() {
                        return gotoScene;
                    }

                    public void setGotoScene(GotoSceneBean gotoScene) {
                        this.gotoScene = gotoScene;
                    }

                    public static class GotoSceneBean {
                        /**
                         * sceneId : 3
                         */
